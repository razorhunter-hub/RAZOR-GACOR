...
<form method="post">
    ...
    <div class="row g-2">
      ...
      <div class="col-4">
        <a href="<?php echo $alamat_website.'rekening/pulsa'; ?>">
          ...
          ?>
            <img src="<?php echo $alamat_website_admin; ?>assets/images/svg/pulsa.svg" alt="Bank" width="25" height="25">
  ...
  <div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    ...
    <div class="col-10 px-4">
      <button type="submit" name="tambah_rekening" class="btn btn-utama rounded-pill text-uppercase py-3 w-100" style="font-size: 12px;">Tambah Akun</button>
    </div>
  </div>
  <div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    <div class="col-10 text-center bg-utama p-2">
