...
<form method="post">
  <div class="row gy-3 gx-0 mb-3">
    <div class="col-6">
      <a href="<?php echo $alamat_website.'riwayat_deposit'; ?>" class="d-flex justify-content-center align-items-center text-uppercase bg-utama mx-3 p-2">
        <img src="<?php echo $alamat_website_admin; ?>assets/images/svg/deposit.svg" alt="Deposit" width="25" height="25" class="me-2">
        Riwayat Deposit
      </a>
    </div>
    <div class="col-6">
      <a href="<?php echo $alamat_website.'riwayat_withdraw'; ?>" class="d-flex justify-content-center align-items-center text-uppercase mx-3 p-2">
        <img src="<?php echo $alamat_website_admin; ?>assets/images/svg/withdrawal.svg" alt="Deposit" width="25" height="25" class="me-2">
        Riwayat Penarikan
      </a>
    </div>
