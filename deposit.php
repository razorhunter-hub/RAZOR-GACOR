...
<?php
  ...
  if (isset($_POST['deposit'])) {
    ...
    $tanggal_deposit = date("Y-m-d H:i:s");
       if($jumlah_deposit < 25000) {
      echo '
        <script>
          alert("Deposit Minimal Sebesar Rp 25.000!");
        </script>';
    } else {
  ...
  <div class="row gy-2 gx-0 d-flex justify-content-center align-items-center mt-5">
    ...
    <div class="col-10">
      <div class="bg-dark rounded p-2">
        ...
        <input type="text" name="jumlah_deposit" class="form-control rounded-0 border-0 mb-2" id="hanya-angka" autocomplete="off" placeholder="Minimal Deposit (Rp 25.000)" required>
    ...
    <div class="col-10">
      <div class="bg-dark rounded p-2">
        ...
        <option>-- Pilih Promo --</option>
            ...
            <option>GARANSI KEKALAHAN 13%</option>
        </select>
      </div>
    </div>
