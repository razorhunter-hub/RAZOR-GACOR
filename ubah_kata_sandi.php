...
<div class="row gy-2 gx-0 mb-3">
  <div class="col-4">
    <a href="<?php echo $alamat_website.'akun_saya'; ?>" class="d-flex justify-content-center align-items-center text-uppercase mx-3 p-2">
      <img src="<?php echo $alamat_website_admin; ?>assets/images/svg/profile.svg" alt="Akun Saya" width="25" height="25" class="me-2">
      Akun Saya
    </a>
  </div>
  <div class="col-4">
    <a href="<?php echo $alamat_website.'ubah_kata_sandi'; ?>" class="d-flex justify-content-center align-items-center text-uppercase btn-utama mx-3 p-2">
      <img src="<?php echo $alamat_website_admin; ?>assets/images/svg/password.svg" alt="Ubah Kata Sandi" width="25" height="25" class="me-2">
      Ubah Kata Sandi
    </a>
  </div>
  <div class="col-4">
    <a href="<?php echo $alamat_website.'profil_saya'; ?>" class="d-flex justify-content-center align-items-center text-uppercase mx-3 p-2">
      <img src="<?php echo $alamat_website_admin; ?>assets/images/svg/edit.svg" alt="Profil Saya" width="25" height="25" class="me-2">
      Profil Saya
    </a>
  </div>
</div>
<form method="post">
  <div class="row gx-0 gy-3 justify-content-center align-items-center mb-3">
    ...
    <div class="col-10 px-4">
      ...
      <button type="submit" name="ubah_kata_sandi" class="btn btn-utama text-uppercase rounded-pill my-3 w-100">Ubah Kata Sandi</button>
    </div>
  </div>
</form>